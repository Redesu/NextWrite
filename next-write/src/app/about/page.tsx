    ...
    return (
        <Box p="5" mx="auto" maxWidth="700px">
            ...
            <Text as="p" size="4" mb="8" align="center" color="gray">
                Next Write is a place for the Next.js community to share their thoughts, ideas, and stories.
            </Text>
            ...
            <Text as="p" size="4" mb="8">
                The project is open source and available on <GitHubLogoIcon width="16" height="16" style={{ marginRight: '4px' }} /><Link href="https://github.com/Redesu/NextWrite" target="_blank" rel="noopener noreferrer">GitHub</Link>
